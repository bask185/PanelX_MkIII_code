...
uint8 I2cEeprom::get_n( uint16_t eeAddress, void * src, int size )
{
...
uint8 I2cEeprom::put_n( uint16_t eeAddress, void * src, int size )
{
...
void I2cEeprom::write( uint16_t eeAddress, uint8 data )
{
	Wire.beginTransmission( i2cAddress ) ;
    Wire.write( highByte(eeAddress) ) ;
    Wire.write( lowByte(eeAddress) ) ;
...
uint8 I2cEeprom::read( uint16_t eeAddress )
{
	Wire.beginTransmission( i2cAddress ) ;
    Wire.write( highByte(eeAddress) ) ;
    Wire.write(  lowByte(eeAddress) ) ;
